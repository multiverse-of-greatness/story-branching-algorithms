class GenerationConfig:
    def __init__(self, min_num_choices: int, max_num_choices: int, min_num_choices_opportunity: int,
                 ...
                 num_endings: int, num_main_characters: int, num_main_scenes: int):
    ...
    def __str__(self):
        return f"""GenerationConfig(min_num_choices={self.min_num_choices}, max_num_choices={self.max_num_choices}, min_num_choices_opportunity={self.min_num_choices_opportunity}, max_num_choices_opportunity={self.max_num_choices_opportunity}, game_genre={self.game_genre}, themes={self.themes}, num_chapters={self.num_chapters}, num_endings={self.num_endings}, num_main_characters={self.num_main_characters}, num_main_scenes={self.num_main_scenes})"""
